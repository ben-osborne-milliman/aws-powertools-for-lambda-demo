...
locals {
  role         = "pwrtlz-demo-3-trc"
  project_path = "../../../../src/lambdas/PwrTlzDemo/PwrTlzDemo.3.Trc"
}
...
module "lambda" {
  ...
  role                  = local.role
  architecture          = "arm64"
  handler_function      = "PwrTlzDemo.3.Trc::PwrTlzDemo.Function::FunctionHandler"
  runtime               = "dotnet8"
  description           = "PowerTools Demo Function - Tracing"
  memory_size           = 128
  timeout               = 60
