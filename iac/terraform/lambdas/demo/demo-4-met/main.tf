...
locals {
  role         = "pwrtlz-demo-4-met"
  project_path = "../../../../src/lambdas/PwrTlzDemo/PwrTlzDemo.4.Met"
}
...
module "lambda" {
  ...
  role                  = local.role
  architecture          = "arm64"
  handler_function      = "PwrTlzDemo.4.Met::PwrTlzDemo.Function::FunctionHandler"
  runtime               = "dotnet8"
  description           = "PowerTools Demo Function - Metrics"
  memory_size           = 128
  timeout               = 60
